                        ...
                        >
                          <span>
                            ...
                            <span className="mt-1 block text-xs text-[var(--text-muted)]">
                              {roundToWhole(food.calories * effectiveServings)} cal · {formatGrams(food.protein * effectiveServings)}p · {formatGrams(food.carbs * effectiveServings)}c · {formatGrams(food.fat * effectiveServings)}f
