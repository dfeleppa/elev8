...
export default function OwnerAgentsClient({ configuredMemberId }: OwnerAgentsClientProps) {
  ...
  return (
    <>
          ...
          <div className="mt-4 space-y-3">
            ...
            <label className="block space-y-1">
              ...
              <div className="flex gap-2">
                ...
                <button
                  type="button"
                  onClick={() => void copyValue(mcpUrl, "chatgpt-oauth-mcp")}
                  className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm font-semibold text-slate-200"
                >
                  {copiedValue === "chatgpt-oauth-mcp" ? "Copied" : "Copy"}
                </button>
              </div>
            </label>
      ...
      <section className="rounded-[28px] border border-white/10 bg-white/5 p-6 shadow-sm">
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <h2 className="mt-2 text-xl font-semibold text-slate-200">Owner Agent Permissions</h2>
          </div>
            ...
            <table className="w-full min-w-[760px] border-collapse">
              <thead>
                <tr>
                  ...
                  <th className="px-4 py-3 text-center text-xs font-semibold uppercase tracking-[0.2em] text-slate-400">
                    Create
                  </th>
                  <th className="px-4 py-3 text-center text-xs font-semibold uppercase tracking-[0.2em] text-slate-400">
                    Read
                    ...
                    {(["create", "read", "update", "delete"] as const).map((action) => (
                      <td key={`${row.key}-${action}`} className="px-4 py-3 text-center align-middle">
                        <input
                          ...
                          className="h-4 w-4 rounded border-white/20 bg-white/5 text-pink-400 focus:ring-pink-400"
        ...
        <div className="mt-6 flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-white/10 bg-white/5 px-4 py-3">
          <p className="text-sm text-slate-300">
            Selected permission switches: <span className="font-semibold text-slate-200">{selectedPermissionCount}</span>
          </p>
          <button
            type="button"
            disabled
      ...
      <section className="grid gap-6 lg:grid-cols-2">
        <article className="rounded-[28px] border border-white/10 bg-white/5 p-6 shadow-sm">
          <p className="text-xs uppercase tracking-[0.2em] text-slate-500">Token Rotation</p>
          <h3 className="mt-2 text-lg font-semibold text-slate-200">Generate New Agent Token</h3>
          ...
          <div className="mt-4 flex flex-wrap items-center gap-2">
            <button
              ...
              className="rounded-full bg-gradient-to-r from-pink-400 to-pink-600 px-4 py-2 text-sm font-semibold text-white shadow-[0_4px_20px_rgba(255,177,196,0.2)] transition hover:brightness-110"
            >
              Generate Token
            </button>
            <button
              ...
              className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm font-semibold text-slate-200 transition hover:border-white/20 disabled:cursor-not-allowed disabled:opacity-50"
            >
              {copied ? "Copied" : "Copy"}
            </button>
          </div>
          ...
          <label className="mt-4 block space-y-1">
            ...
            <input
              ...
              className="w-full rounded-2xl border border-white/10 bg-white/5 px-4 py-2 text-sm text-slate-200 placeholder:text-slate-500 focus:border-cyan-400 focus:outline-none"
            />
          </label>
        ...
        <article className="rounded-[28px] border border-white/10 bg-white/5 p-6 shadow-sm">
          ...
          <h3 className="mt-2 text-lg font-semibold text-slate-200">Test Agent Nutrition API</h3>
          ...
          <div className="mt-4 grid gap-3">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <label className="space-y-1">
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-white/10 bg-white/5 px-4 py-2 text-sm text-slate-200 focus:border-cyan-400 focus:outline-none"
                />
              </label>
              <label className="space-y-1">
            ...
            <div className="grid gap-3 sm:grid-cols-4">
              <label className="space-y-1">
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-white/10 bg-white/5 px-3 py-2 text-sm text-slate-200 focus:border-cyan-400 focus:outline-none"
                />
              </label>
              <label className="space-y-1">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                disabled={isCreating}
                className="rounded-full bg-gradient-to-br from-pink-400 to-pink-600 px-4 py-2 text-sm font-semibold text-white shadow-[0_4px_20px_rgba(255,177,196,0.2)] transition hover:brightness-110 disabled:opacity-60"
              >
              ...
              <button
                ...
                disabled={isUpdating}
                className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm font-semibold text-slate-200 transition hover:border-white/20 disabled:opacity-60"
              >
            ...
            <label className="space-y-1">
              ...
              <pre className="max-h-48 overflow-auto rounded-2xl border border-white/10 bg-white/5 p-3 text-xs text-slate-300">
