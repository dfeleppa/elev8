...
const inputClass =
  "w-full rounded-2xl border border-[var(--nutrition-card-border)] bg-[var(--nutrition-surface-soft)] px-3 py-2.5 text-sm font-bold text-[var(--nutrition-text-primary)] focus:border-[rgba(20,210,220,0.34)] focus:outline-none sm:py-3";
const primaryBtn =
  "inline-flex items-center justify-center gap-2 rounded-2xl bg-[var(--nutrition-accent-teal)] px-5 py-2.5 text-sm font-bold text-[var(--nutrition-accent-teal-ink)] shadow-[0_14px_30px_rgba(20,210,220,0.24)] transition hover:brightness-105 disabled:cursor-not-allowed disabled:opacity-60 sm:py-3";
  ...
  return (
    <div className="premium-glass-card p-4 sm:p-5">
      <div className="flex flex-col gap-1">
        <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[var(--nutrition-accent-pink)] sm:text-[11px]">
          Weekly Check-In
        </p>
        <h2 className="text-[20px] font-bold text-[var(--nutrition-text-primary)] sm:text-[22px]">Coach review</h2>
      </div>
      ...
      {step === "start" ? (
        !checkInDue ? (
          <div className="mt-3">
            <p className="flex items-center gap-2 rounded-2xl border border-[var(--nutrition-card-border)] bg-[var(--nutrition-surface-faint)] px-3 py-2.5 text-sm font-bold text-[var(--nutrition-text-muted)]">
            ...
            <p className="mt-3 text-sm font-semibold leading-6 text-[var(--nutrition-text-soft)]">
          ...
          <div className="mt-3">
            <p className="text-sm font-semibold leading-6 text-[var(--nutrition-text-soft)]">
            ...
            <ol className="mt-3 space-y-1.5 text-sm font-semibold text-[var(--nutrition-text-muted)]">
      ...
      {step === "metrics" ? (
        <div className="mt-3">
          ...
          <div className="mt-3 grid gap-3 sm:grid-cols-2">
            <label className="block space-y-1.5 text-[11px] font-bold uppercase tracking-[0.12em] text-[var(--nutrition-text-soft)] sm:text-xs">
              Bodyweight (lbs)
              <input
                value={weight}
      ...
      {step === "accountability" ? (
        <div className="mt-3">
          {hasTodayWeight ? (
            <p className="mb-3 flex items-center gap-2 rounded-2xl border border-[rgba(20,210,220,0.18)] bg-[rgba(20,210,220,0.08)] px-3 py-2 text-sm font-bold text-[var(--nutrition-teal-text)]">
              <Scale className="h-4 w-4" aria-hidden="true" />
              Using today&apos;s weigh-in: {todaysWeight?.toFixed(1)} lb
            </p>
          ) : null}
          <p className="text-base font-bold text-[var(--nutrition-text-primary)]">Were you accountable this week?</p>
          <p className="mt-1 text-sm font-semibold leading-6 text-[var(--nutrition-text-soft)]">
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-2">
            <button
              ...
              disabled={submitting}
              className="inline-flex items-center justify-center gap-2 rounded-2xl bg-[var(--nutrition-accent-teal)] px-5 py-3 text-sm font-bold text-[var(--nutrition-accent-teal-ink)] shadow-[0_14px_30px_rgba(20,210,220,0.24)] transition hover:brightness-105 disabled:opacity-60"
            >
            ...
            <button
              ...
              disabled={submitting}
              className="inline-flex items-center justify-center gap-2 rounded-2xl border border-[var(--nutrition-card-border)] bg-[var(--nutrition-surface-soft)] px-5 py-3 text-sm font-bold text-[var(--nutrition-text-primary)] transition hover:bg-[var(--nutrition-surface-solid)] disabled:opacity-60"
            >
...
function CheckInResult({ result, onRestart }: { result: ResultPayload; onRestart: () => void }) {
  ...
  return (
    <div className="mt-3">
      ...
      >
        <p className="flex items-center gap-2 text-base font-bold text-[var(--nutrition-text-primary)]">
          <CheckCircle2 className="h-5 w-5 text-[var(--nutrition-status-good)]" aria-hidden="true" />
          Check-in complete
        </p>
        <p className="mt-2 text-sm font-bold text-[var(--nutrition-text-primary)]">{headline}</p>
        {action === "adjusted" && fromCals && toCals ? (
          <p className="mt-1 text-sm font-semibold text-[var(--nutrition-text-muted)]">
            {Math.round(fromCals)} → {Math.round(toCals)} kcal/day
          </p>
        ) : null}
        {rec?.reason ? <p className="mt-2 text-sm font-medium leading-6 text-[var(--nutrition-text-soft)]">{rec.reason}</p> : null}
        <p className="mt-3 text-xs font-bold uppercase tracking-[0.12em] text-[var(--nutrition-text-soft)]">
      ...
      <button
        type="button"
        onClick={onRestart}
        className="mt-3 rounded-2xl border border-[var(--nutrition-card-border)] bg-[var(--nutrition-surface-soft)] px-4 py-2 text-sm font-bold text-[var(--nutrition-text-primary)] transition hover:bg-[var(--nutrition-surface-solid)]"
      >
        Done
      </button>
    </div>
