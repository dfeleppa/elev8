...
function getOrderedColumns(rows: MemberRow[]) {
  ...
  const preferred = ["id", "member_id", "first_name", "last_name", "email", "created_at", "updated_at"];
  ...
  return (
    <SidebarShell mainClassName="mx-auto w-full max-w-6xl px-5 py-10 lg:py-16">
      <section className="space-y-8">
        <header>
          <h1 className="text-3xl font-semibold text-slate-100">Gym Members</h1>
          <p className="mt-3 text-sm text-slate-400">Full rows from the members roster table.</p>
        </header>
