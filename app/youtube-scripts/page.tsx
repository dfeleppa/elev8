  ...
  return (
    <div className="min-h-screen flex">
      ...
      <main className="flex-1 p-8">
        ...
        <form id="scriptForm" className="space-y-2" onSubmit={(e) => { e.preventDefault(); }}>
          ...
          <div>
            <button type="button" onClick={() => alert('Save handled via API')} className="px-4 py-2 bg-blue-600 text-white rounded">Save</button>
          </div>
        </form>
